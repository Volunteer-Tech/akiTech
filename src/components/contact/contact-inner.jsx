  ...
  contact_data: [
    {
      id: 1,
      icon: icon_1,
      title: "contact@akiTech.com",
      link: "mailto:contact@akiTech.com",
    },
    {
      id: 2,
      icon: icon_2,
      title: "(+251)929 34 12XX",
      link: "tel:(+251)929 34 12XX",
    },
    {
      id: 3,
      icon: icon_3,
      title: "Bahir Dar, Abay Mado, Ethiopia",
      link: "https://maps.app.goo.gl/fbu84HhW59CPCJGH7",
    },
  ],
};
                ...
                <div key={i} className="col-xl-4 col-lg-4">
                  <div className="contact-inner-item d-flex align-items-center justify-content-center">
                    <div className="contact-inner-img contact-img-1">
                      <Image src={item.icon} alt="akiTech" />
                    </div>
