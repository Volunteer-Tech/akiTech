    ...
    <>
      ...
      >
        <div className="scroll-bg d-none d-sm-block">
          <Image src={scroll_bg} alt="akiTech" />
        </div>
            ...
            <div className="col-xl-6 col-lg-6">
              ...
              <div className="tp-hero-2__user p-relative">
                ...
                <div className="tp-hero-2__user-img">
                  <Image src={users_img} alt="akiTech" />
                </div>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="tp-hero-2__right text-end p-relative">
                <div
                  ...
                  data-wow-delay=".5s"
                >
                  <Image src={hero_shape_1} alt="akiTech" />
                </div>
                ...
                >
                  <Image src={hero_shape_2} alt="akiTech" />
                </div>
                ...
                >
                  <Image src={hero_shape_3} alt="akiTech" />
                </div>
                ...
                >
                  <Image src={hero_shape_4} alt="akiTech" />
                </div>

                <div className="tp-hero-2__sub-img-4">
                  <Image src={hero_shape_5} alt="akiTech" />
                </div>
              </div>
            </div>
          </div>
