...
const about_content = {
  ...
  des: (
    <>
      ...
      sensitive information normal business processes.!
    </>
  ),
  feature_1: (
    <>
      High-Performance <br /> Solutions
    </>
  ),
  feature_2: (
    <>
      Best Cyber Security <br /> Solutions.
    </>
  ),
  btn_text: "About Us",
};
          ...
          <div className="row align-items-center">
            ...
            >
              <div className="tp-about-left-img text-md-center p-relative text-start z-index">
                <Image src={img_2} alt="akiTech" />
                <div className="tp-about-top-img">
                  <Image src={img_3} alt="akiTech" />
                </div>
              </div>
            </div>
            <div
