...
const service_content = {
  ...
  description: (
    <>
      akiTech provides all customer management <br /> service within one
      software.
    </>
  ),
};
          ...
          >
            <div className="row">
              {service_data.slice(9, 13).map((item, i) => (
                <div
                  key={i}
                  className={`col-xl-3 col-lg-4 col-md-6 mb-50 tp-service-4-border-right service-border-trang-${item.cls}`}
                >
