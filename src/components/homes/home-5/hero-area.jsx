    ...
    <>
      <div className="tp-hero-area tp-hero-five__ptb-5 p-relative grey-bg-2 fix">
        <div className="tp-hero-five__shape-2">
          <Image src={shape_1} alt="akiTech" />
        </div>
        <div className="tp-hero-five__shape-3">
          <Image src={shape_2} alt="akiTech" />
        </div>
        <div className="tp-hero-five__shape-4">
          <Image src={shape_3} alt="akiTech" />
        </div>
              ...
              <div className="tp-hero-five-section-wrap">
                <div className="tp-hero-five-section-box z-index">
                  <h3 className="tp-hero-title-5 hero-text-anim-2">
                    ...
                    <i>
                      <i className="child-2">
                        <span className="child-2">Management</span> With <br />
                      </i>
                    </i>
                    <i>
                      <i className="child-2">Software</i>
                    </i>
                  </h3>
                  <p
                    ...
                    data-wow-delay=".5s"
                  >
                    A simple solution for building the optimal work <br />{" "}
                ...
                >
                  <Link
                    className="tp-btn-blue-lg purple-bg circle-effect mr-15 mb-20"
                    href="/"
                  >
                    Get Started
                  </Link>
                  <Link className="tp-btn-grey mb-20" href="/service-details">
                    Try a Damo
                  </Link>
                </div>
              </div>
        ...
        <div className="tp-hero-five-2-thumb-main p-relative">
          ...
          <div className="tp-hero-five-2-sub-img-1 d-none d-md-block">
            <Image src={shape_5} alt="akiTech" />
          </div>
          <div className="tp-hero-five-2-sub-img-2 d-none d-md-block">
            <Image src={shape_6} alt="akiTech" />
          </div>
        </div>
      </div>
    </>
