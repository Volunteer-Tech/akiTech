  ...
  job_post_details: [
    {
      ...
      description: (
        <>
          ...
          If you are going to use a passage of Lorem Ipsum,anything embarrassing
          hidden.
        </>
      ),
    },
    ...
    },
    {
      ...
      description: (
        <>
          ...
          include a content marketing strategy.
        </>
      ),
      experiences: [
        <>Flexible hours</>,
    ...
    },
    {
      ...
      experiences: [
        <>
          Experience building software and systems that balance <br />{" "}
    ...
    },
    {
      ...
      description: (
        <>
          TBachelors Degree in Interaction, Graphic Design, Media Arts or
          similar.
        </>
      ),
    },
            ...
            <div className="col-xl-7 col-lg-7">
              <div className="career-details-wrapper">
                ...
                {job_post_details.map((item, i) => (
                  <div
                    key={i}
                    className={`career-details-job-responsiblity ${item.cls}`}
                  >
            ...
            <div className="col-xl-5 col-lg-5 career-details-pin">
                  ...
                  <div className="career-details-apply-info-box">
                          ...
                          <div className="col-12">
                            <div className="postbox__select mb-30">
                              <NiceSelect
                                options={[
                                  {
                                    value: "Your Inquiry about",
                                    text: "Your Inquiry about",
                                  },
                    ...
                    <div className="col-xxl-12">
                      <div className="postbox__authorization-title-box">
                        <h5 className="career-details-title-xs pb-15">
                    ...
                    <div className="col-xxl-12">
                      ...
                      <div className="postbox__resume mb-30">
                        ...
                        <label htmlFor="cv">
                          <span>Drag to upload your resume, or browse</span>
                        </label>
                      </div>
                    </div>
                    <div className="col-xxl-12">
              ...
              <div className="col-xxl-12">
                ...
                <div className="career-details-bottom-text text-center">
                  <Link href="#">Employee at akiTech?</Link>
                </div>
              </div>
            </div>
          </div>
