...
const pricing_data_monthly = {
  header_text: (
    <>
      You pay <span>$59.00/mo</span> today Renews <br /> April 2024 For{" "}
      <span>$69.00/mo</span>
    </>
  ),
  // price header data
  price_header: [
    {
      ...
      description: (
        <>
          Collect more submissions, <br /> access most of the features
        </>
      ),
      price: 18,
      price_yearly: 36,
  ...
  price_feature_info: [
    {
      id: 1,
      active: "",
      info: ["02", "12", "Limited", "100", "Limited"],
    },
    {
      id: 2,
      active: "active",
...
const { header_text, price_header, price_feature, price_feature_info } =
  pricing_data_monthly;
                      ...
                      <div className="col-4">
                        <div className="tp-price-header">
                          <div className="tp-price-header-img">
                            <Image src={header_img} alt="akiTech" />
                          </div>
                        ...
                        <div className="tp-price-top-wrapper">
                          {price_header.map((item, i) => (
                            ...
                            >
                              ...
                              <div className="tp-price-top-title-wrapper">
                                <h4>
                                  ${item.price_yearly} <span>/mo</span>
                                </h4>
                                <p>{item.date}</p>
                                <Link className="tp-btn-service" href="#">
                                  Get Started
