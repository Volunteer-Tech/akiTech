      ...
      <div className="tpoffcanvas-area">
        <div className={`tpoffcanvas ${sidebarOpen && "opened"}`}>
          ...
          <div className="tpoffcanvas__instagram text-center">
            ...
            <Link href="#">
              <Image src={canvus_img_1} alt="akiTech" />
            </Link>
            <Link href="#">
              <Image src={canvus_img_2} alt="akiTech" />
            </Link>
            <Link href="#">
              <Image src={canvus_img_3} alt="akiTech" />
            </Link>
            <Link href="#">
              <Image src={canvus_img_4} alt="akiTech" />
            </Link>
          </div>
          <div className="tpoffcanvas__info text-center">
            <h4 className="offcanva-title">we are here</h4>
            <Link
              href="https://maps.app.goo.gl/Mq2WUAdsjkYs3FVL9"
              target="_blank"
            >
              Bahir Dar, Abay Mado, <br />
              Ethiopia
            </Link>
          </div>
