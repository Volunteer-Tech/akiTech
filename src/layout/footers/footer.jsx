...
const footer_content = {
  ...
  phone: "(+251)929 34 12XX",
  contact_mail: "contact@info.com",
  location: "Bahir Dar, Abay Mado, Ethiopia,",

  copy_right: (
    <>
      Full Copyright & Designed By{" "}
      <Link href="https://www.linkedin.com/in/aklilu-mandefro">Aklilu</Link> and{" "}
      <Link href="https://github.com/annarihu">Anna </Link>
    </>
  ),
                      ...
                      <div className="tp-footer__contact-info tp-footer__icon-space">
                        <ul>
                          ...
                          <li>
                            ...
                            <Link
                              href="https://maps.app.goo.gl/fbu84HhW59CPCJGH7"
                              target="_blank"
                            >
                              {location}
                            </Link>
                    ...
                    <div className="tp-copyright__lang">
                      <ul>
                        <li>
                          ...
                          >
                            <span>
                              English (US)<i className="fal fa-angle-down"></i>
                            </span>
                          </button>
